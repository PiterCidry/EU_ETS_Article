...
results[j, 4] <- adf.test(Data.all$GDP_growth)$statistic
results[j, 5] <- adf.test(Data.all$GDP_growth)$p.value
results[j, 2] <- "All"
j <- j + 1

results[j, 4] <- adf.test(Data.combustion$GDP_growth)$statistic
results[j, 5] <- adf.test(Data.combustion$GDP_growth)$p.value
results[j, 2] <- "Combustion"
j <- j + 1

results[j, 4] <- adf.test(Data.other$GDP_growth)$statistic
results[j, 5] <- adf.test(Data.other$GDP_growth)$p.value
results[j, 2] <- "Other"
results[m:j, 3] <- "ADF test (GDP_Growth)"
results[n:j, 1] <- "-"
j <- j + 1
m <- j
n <- j
...
# Dynamic panel var models (All phases, dependent - GDP)
...
k <- j + length(summary(model_pvar_all)$results$GDP_growth@coef.names) - 1
results[j:k, 3] <- summary(model_pvar_all)$results$GDP_growth@coef.names
results[j:k, 4] <- summary(model_pvar_all)$results$GDP_growth@coef
results[j:k, 5] <- summary(model_pvar_all)$results$GDP_growth@pvalues
j <- j + length(summary(model_pvar_all)$results$GDP_growth@coef.names)
...
k <- j + length(summary(model_pvar_combustion)$results$GDP_growth@coef.names) - 1
results[j:k, 3] <- summary(model_pvar_combustion)$results$GDP_growth@coef.names
results[j:k, 4] <- summary(model_pvar_combustion)$results$GDP_growth@coef
results[j:k, 5] <- summary(model_pvar_combustion)$results$GDP_growth@pvalues
j <- j + length(summary(model_pvar_combustion)$results$GDP_growth@coef.names)
results[j, 3] <- "No. of instruments/Observations"
...
k <- j + length(summary(model_pvar_other)$results$GDP_growth@coef.names) - 1
results[j:k, 3] <- summary(model_pvar_other)$results$GDP_growth@coef.names
results[j:k, 4] <- summary(model_pvar_other)$results$GDP_growth@coef
results[j:k, 5] <- summary(model_pvar_other)$results$GDP_growth@pvalues
j <- j + length(summary(model_pvar_other)$results$GDP_growth@coef.names)
results[j, 3] <- "No. of instruments/Observations"
...
write.xlsx(results, file = "Results/Results_GDP_all_data_sectors_countries_years.xlsx", showNA = FALSE, row.names = FALSE)

effects <- effects[complete.cases(results),]
...
write.xlsx(effects, file = "Results/Effects_GDP_all_data_sectors_countries_years.xlsx", showNA = FALSE, row.names = FALSE)
